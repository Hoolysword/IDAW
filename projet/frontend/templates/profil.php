      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            <h5 class="my-3"><?php echo $_SESSION['nom'];echo"   ". $_SESSION['prenom']?></h5>
            <p class="text-muted mb-1">création du compte:11 janvier 2022</p>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?php echo $_SESSION['nom'];echo"   ". $_SESSION['prenom']?></p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">0605040120</p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">10 rue des roses</p>
              </div>
            </div>
          </div>
        </div>
